            ...
            <div class="tip_box mlr-10">
                <div class="tip_box_list plr10">
                    <div class="box_padding">
                        <a class="tip_link" href="#"></a>
                        <div class="tip_img_wrap">
                            <img class="tip_img" src="../resources/img/community/tip/tip_img_01.webp"
                                alt="tip">
                            <span class="tip_new">
                        ...
                        <div class="tip_con">
                            <h1 class="tip_con_title">낡은 집에서 가능성을 발견한, 그림 같은 집</h1>
                            <div class="tip_con_author">자취플래너✒️</div>
