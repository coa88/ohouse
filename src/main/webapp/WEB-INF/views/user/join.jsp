    ...
    <div class="join-form">
        ...
        <form action="/user/join" method="post">
            ...
            <div class="join-form-email">
                <span><input type="text" class="join-form-email-input" name="emailId" placeholder="이메일을 입력해주세요." onchange="chkEmail()"></span>
                <div class="emailChk">이메일형식으로 입력해주세요.</div>
            ...
            <div><input type="text" class="join-form-input" name="nm" placeholder="별명 (2~10자)"></div>
